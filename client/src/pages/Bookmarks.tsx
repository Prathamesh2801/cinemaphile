                ...
                >
                  ...
                  <div className="flex flex-col flex-1 min-w-0">
                    ...
                    <div className="mt-2 flex items-center gap-4">
                      <span className="text-sm text-neutral-400 font-doto">
                        {movie.Year}
                      </span>
                    ...
                    <button
                      onClick={async (e) => {
                        e.stopPropagation();
                        try {
                          await apiClient.delete(`/users/bookmarks/${movie.imdbID}`);
                          setSavedMovies(savedMovies.filter(m => m.imdbID !== movie.imdbID));
                          toast.success('Movie removed from bookmarks');
                        } catch (error) {
                          console.error('Error removing bookmark:', error);
                          toast.error('Failed to remove movie from bookmarks');
                        }
                      }}
